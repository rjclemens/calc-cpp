...
op op6{'^', 4, RIGHT, BINARY, [] (complex a, complex b){return std::pow(b.re, a.re);}};
...
func f10{"sqrt", ONE_INPUT, [] (complex a, complex b){return std::sqrt(a.re);}};
func f11{"cbrt", ONE_INPUT, [] (complex a, complex b){return std::cbrt(a.re);}};
func f12{"exp", ONE_INPUT, [] (complex a, complex b){return std::exp(a.re);}};
